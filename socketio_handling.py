...
def register_socketio_handlers(socketio, mysql):
    ...
    def handle_message(data):
        ...
        message_id = dbfunctions.save_message(mysql, username, partner, message)
    ...
    def handle_mark_read(data):
        ...
        dbfunctions.mark_message_as_read(mysql, message_id, reader)
    ...
    def handle_get_user_profile(data):
        username = data['username']
        profile = dbfunctions.get_user_profile(mysql, username)
        emit('user_profile', {'username': username, 'avatar': profile[1], 'status_message': profile[2]})
    ...
    def handle_update_user_profile(data):
        ...
        dbfunctions.update_user_profile(mysql, username, avatar, status_message)
